...
\paragraph{À quelle(s) problématique(s) l'article répond ?} Réduction de la mémoire, implémentation élégante avec probabilité de garder les exemples récents fortes.

\paragraph{Quelles sont les pistes à explorer et ont-elles  été explorées par d'autres articles ?} Pour moi, il y a un petit problème d'implémentation car l'algorithme est très coûteux en terme de RAM pour des gains de performance faibles.
